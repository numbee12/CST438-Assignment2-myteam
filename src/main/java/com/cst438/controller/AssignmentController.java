...
//        return new AssignmentDTO(assignment.getAssignmentId(), assignment.getTitle(), assignment.getDueDate(), assignment.getSection());
//    }
...
//    }
        ...
        public AssignmentDTO updateAssignment(@RequestBody AssignmentDTO dto) {
            ...
            // TODO remove the following line when done
//            Assignment u = assignmentRepository.findById(AssignmentDTO.getId().orElse(null);
//            if(u == null) {
//                throw  new ResponseStatusException( HttpStatus.NOT_FOUND, "Assignment not found "+ AssignmentDTO.getId());
//            } else {
//                u.setTitle(AssignmentDTO.getTitle());
//                u.setDueDate(AssignmentDTO.getDueDate());
